...
#Get the IP of the packet capture host
...
#Data inflow and outflow statistics
...
#Common Protocol Traffic Statistics
...
#Statistics on the number of protocols with the most traffic
