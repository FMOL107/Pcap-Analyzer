...
class PcapDecode:
    def __init__(self):
        #ETHER:Read Ethernet layer protocol configuration file
        ...
        #IP:Read IP layer protocol configuration file
        ...
        #PORT:Read application layer protocol port configuration file
        ...
        #UDP:Read UDP layer protocol configuration file
    ...
    #Parsing Ethernet layer protocols
